...
class SpecialProductsWidget extends StatelessWidget {
  const SpecialProductsWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    BlocProvider.of<ProductCubit>(context).getAllSpecialProducts();
    return BlocConsumer<ProductCubit, ProductState>(
      buildWhen: (previous, current) => current.productStatus is GetSpecialProductsStatus ,
      ...
      builder: (context, state) {
        ...
        if (state.productStatus is GetSpecialProductsStatus) {
          final status = state.productStatus as GetSpecialProductsStatus;
